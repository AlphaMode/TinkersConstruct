...
class DefinitionToolStatsTest extends BaseMcTest {
  ...
  void jsonSerializeTest() {
    ...
    assertThat(GsonHelper.getFloat(object, ToolStats.DURABILITY.getName().toString())).isEqualTo(10);
    assertThat(GsonHelper.getFloat(object, ToolStats.ATTACK_SPEED.getName().toString())).isEqualTo(2.5f);
  }
