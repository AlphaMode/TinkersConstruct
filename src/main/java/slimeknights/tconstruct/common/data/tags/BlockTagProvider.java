...
public class BlockTagProvider extends BlockTagsProvider {
  ...
  private void addCommon() {
    ...
    TinkerCommons.clearStainedGlass.forEach((glassColor, clearStainedGlassBlock) -> impermeable.add(clearStainedGlassBlock));
  ...
  private void addWorld() {
    ...
    this.tag(TinkerTags.Blocks.SLIMY_TREE_TRUNKS).addTag(TinkerTags.Blocks.SLIMY_LOGS).addTag(TinkerTags.Blocks.CONGEALED_SLIME);

    // foliage
    TagsProvider.TagAppender<Block> leavesBuilder = this.tag(TinkerTags.Blocks.SLIMY_LEAVES);
    TagsProvider.TagAppender<Block> wartBuilder = this.tag(BlockTags.WART_BLOCKS);
  ...
  private void addSmeltery() {
    ...
    TinkerSmeltery.searedTank.forEach((tankType, searedTankBlock) -> searedTankBuilder.add(searedTankBlock));
    TagAppender<Block> scorchedTankBuilder = this.tag(TinkerTags.Blocks.SCORCHED_TANKS);
    TinkerSmeltery.scorchedTank.forEach((tankType, searedTankBlock) -> scorchedTankBuilder.add(searedTankBlock));
