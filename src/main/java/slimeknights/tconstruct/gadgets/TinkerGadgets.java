...
public final class TinkerGadgets extends TinkerModule {
  ...
  public static final CreativeModeTab TAB_GADGETS = new SupplierItemGroup(TConstruct.MOD_ID, "gadgets", () -> new ItemStack(TinkerGadgets.slimeSling.get(SlimeType.EARTH)));
